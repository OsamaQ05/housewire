...
const styles = StyleSheet.create({
  ...
  coverArt: { position: 'absolute', top: 0, right: 0, bottom: 0, left: 0, opacity: 0.52 },
  coverArtVeil: { position: 'absolute', top: 0, right: 0, bottom: 0, left: 0, backgroundColor: 'rgba(6,7,5,0.58)' },
